  ...
  >
    ...
    >
      <v-toolbar dark color="primary">
        ...
        <v-btn class="mr-2 white--text" color="teal">
          ...
          <a
            ...
            :href="`http://10.20.33.110:9008/storage/cdn/damagePhotos/${PhotoShow.filename}`"
            download
            target="_blank"
          >
            download picture</a
      ...
      <v-card>
        <div class="p-100">
          <v-img
            :lazy-src="`http://10.20.33.110:9008/storage/cdn/damagePhotos/${PhotoShow.filename}`"
            max-height="90%"
            max-width="100%"
            :src="`http://10.20.33.110:9008/storage/cdn/damagePhotos/${PhotoShow.filename}`"
          ></v-img>
        </div>
      </v-card>
    </v-dialog>
                  ...
                  <v-row>
                    ...
                    >
                      <v-img
                        max-height="150"
                        max-width="200"
                        :src="`http://10.20.33.110:9008/storage/cdn/damagePhotos/${item.filename}`"
                        aspect-ratio="1"
